	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 1000px;">
		...
		<div style="margin-top: 1%;">
			<c:forEach items="${sessionScope.data }" var="q" end="0">
				<div style="margin-top: 1%;">
					...
					<a href="Employee?flag=Entery&flag2=head&id=${q.id }"> In </a> <a
						href="Employee?flag=Exite&flag2=head&id=${q.id }"> Out </a>
				</div>
			</c:forEach>
		</div>
		<div style="padding-top: 1%;">
			...
			<c:forEach items="${sessionScope.data }" var="q" end="0">
				<div style="margin-top: 1%;">
					<a
						href="<%=request.getContextPath()%>/Employee?flag=EmployeeEdit&flag2=head&id=${q.id }">Edit
						Profile</a>
				</div>
			</c:forEach>
		</div>
